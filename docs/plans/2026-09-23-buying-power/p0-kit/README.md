...
| ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| `preregistration-template.md`                                          | The `p0_preregistration` decision record — fill in, sign, freeze **before** collecting any contract data.                                                                                                                                   | Filled and signed 2026-09-24 (products: PowerSchool, IXL, Canvas; state: Texas) — **review before collection starts**, see its provenance note |
