...
- **Mermaid renders in [`dashboard.html`](../../plugins/ravenclaude-core/dashboard.html)** ([▶ view rendered](https://mcorbett51090.github.io/RavenClaude/plugins/ravenclaude-core/dashboard.html)) and GitHub natively — the visual diagram and the source-text are the same artifact
