...
model: <REQUIRED since 2026-09-14 — a TIER ALIAS: haiku | sonnet | opus (fable | inherit accepted); full model ids rejected; gated by check-frontmatter.py, roster share ratcheted by Gate 287. Pick from the role → tier table in plugins/ravenclaude-core/knowledge/model-tier-delegation.md>
