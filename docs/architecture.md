...
**Planned plugins** (in PR queue): web-design (PR #16). On the roadmap beyond that: EdTech (built around the partner-success-manager pattern), Salesforce. See [`./plugin-roadmap-analysis.md`](./plugin-roadmap-analysis.md) for the prioritization analysis behind the finance / regulatory-compliance / web-design selection.
