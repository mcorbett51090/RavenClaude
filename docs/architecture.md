...
| [`behavioral-mental-health-practice`](../plugins/behavioral-mental-health-practice/) | Outpatient behavioral / mental-health clinic ops: 5 agents (practice-ops-lead / intake-and-scheduling-analyst / clinical-documentation-advisor / telehealth-operations-lead / behavioral-billing-compliance-advisor) — access/no-shows, treatment plans + MBC, telehealth + licensure, 42 CFR Part 2 vs HIPAA, authorizations. 3 skills, decision trees + 2026 map, 6 best-practices, advisory hook, bh_calc.py. Generic RCM → medical-revenue-cycle. |
| [`embedded-iot-firmware`](../plugins/embedded-iot-firmware/) | Embedded / IoT firmware: 4 agents (embedded-architect / firmware-engineer / rtos-engineer / iot-connectivity-engineer) — bare-metal vs RTOS, ISRs/DMA/static allocation, RTOS task design, device-to-cloud (MQTT) + OTA A/B + secure boot. C/C++/Rust, FreeRTOS/Zephyr, STM32/ESP32/nRF. 3 skills, decision trees + 2026 map, 6 best-practices, advisory hook. Secure boot → security-engineering; IoT backplane → aws/azure-cloud. |
