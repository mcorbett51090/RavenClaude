...
| [`platform-engineering`](../plugins/platform-engineering/) | Internal developer platform / platform-as-product: 3 agents (platform-architect / developer-portal-engineer / golden-paths-and-adoption-engineer) — thinnest viable platform + Team Topologies, the developer portal & software catalog (Backstage/Port/Cortex, ownership, scaffolder templates, scorecards), self-service golden paths + guardrails-as-defaults (Crossplane/Score + policy-as-code), and adoption measured as a product (DORA + DevEx + paved-road coverage). The paved-road layer above devops-cicd / cloud-native-kubernetes / terraform-iac / observability-sre. 3 skills, 10 best-practices, decision-tree knowledge bank, advisory hook. |
...
| [`revops`](../plugins/revops/) | Revenue-operations (B2B GTM) team — 3 agents (revops-architect, pipeline-and-forecast-analyst, gtm-systems-engineer) for the lead-to-cash revenue engine above the CRM and warehouse: the funnel/bowtie definition, the RevOps data model, marketing↔sales↔CS SLAs, the GTM tech stack... |
...
| [`localization-i18n`](../plugins/localization-i18n/) | Software & content localization engineering team — 3 agents (i18n-architect, localization-engineer, localization-qa) for shipping software in many languages: internationalization architecture (ICU MessageFormat, CLDR/locale data, pluralization & gender/select, RTL/bidi, date/number/currency... |
| [`wealth-management-ria`](../plugins/wealth-management-ria/) | Personal financial-advisory / RIA-practice team — 3 agents (financial-planner, portfolio-analyst, advisory-compliance-and-client-review-lead) for the planning, portfolio, and oversight craft of a Registered Investment Adviser serving individual clients: goal-based planning (retirement &... |
| [`people-ops-hr`](../plugins/people-ops-hr/) | People Operations / HR team for SMBs — 3 agents (people-ops-generalist, talent-acquisition-lead, total-rewards-analyst) for the human side of a company: the employee lifecycle (onboarding to offboarding), handbook & policy authoring, HRIS data hygiene, employee-relations basics, leave/PTO,... |
...
| [`construction-field-management`](../plugins/construction-field-management/) | Construction project delivery, FIELD side — 3 agents (project-engineer, cost-and-change-controls-lead, field-and-safety-coordinator) for executing a construction project in the field, distinct from the design side: RFIs / submittals / daily logs / document control / schedule coordination, the... |
| [`property-management-residential`](../plugins/property-management-residential/) | Residential property-management team — 3 agents (leasing-and-tenant-ops, maintenance-coordinator, owner-and-portfolio-reporting-analyst) for running rental housing as an operation: the leasing funnel and applicant screening, the lease lifecycle (renewals, rent increases, move-in/move-out),... |
| [`behavioral-health-practice`](../plugins/behavioral-health-practice/) | Outpatient behavioral / mental-health practice operations team — 3 agents (practice-operations-lead, clinical-documentation-specialist, billing-and-authorization-lead) for the operational and documentation layer of a behavioral-health clinic: intake and scheduling, no-show management, telehealth... |
...
| [`embedded-iot-engineering`](../plugins/embedded-iot-engineering/) | Embedded firmware & IoT/edge engineering team — 3 agents (firmware-architect, embedded-engineer, iot-connectivity-engineer) for the constrained-device layer below the cloud: firmware architecture (RTOS vs bare-metal, MCU selection, memory & power budgets, HAL/driver layering, boot & OTA... |
| [`content-and-growth-marketing`](../plugins/content-and-growth-marketing/) | Content strategy & growth-marketing team — 3 agents (content-strategist, seo-program-lead, lifecycle-marketing-engineer) for the layer above a marketing site and analytics warehouse: editorial strategy and topic clusters/pillars, content briefs, distribution & repurposing; technical + on-page +... |
...
| [`public-sector-grants`](../plugins/public-sector-grants/) | Government & nonprofit grants team — 3 agents (grant-strategist, proposal-writer, grants-compliance-analyst) for the funder-side discipline of winning and managing public grants: opportunity search & fit assessment, funder research, logic model / theory of change and go/no-go (strategist);... |
| [`hospitality-hotel-operations`](../plugins/hospitality-hotel-operations/) | Hospitality / lodging hotel-operations team — 3 agents (hotel-operations-lead, revenue-manager, guest-experience-analyst) for running a property as a business: front-office / PMS operations, housekeeping, the guest journey, SOPs, labor scheduling, and maintenance/engineering coordination;... |
| [`retail-store-operations`](../plugins/retail-store-operations/) | Brick-and-mortar retail store-operations team — 3 agents (store-operations-lead, merchandising-analyst, inventory-and-replenishment-planner) for the four-wall store: store SOPs and daily operations, labor scheduling and store P&L, loss prevention and shrink, customer experience; planograms and... |
| [`data-science-research`](../plugins/data-science-research/) | Exploratory data science & reproducible research team — 3 agents (exploratory-data-scientist, feature-and-modeling-engineer, research-reproducibility-engineer) for the analysis layer between raw data and a defensible result: data profiling/cleaning, EDA, hypothesis generation, and communicating... |
| [`insurance-life-health-benefits`](../plugins/insurance-life-health-benefits/) | Life, health & employee-benefits insurance team — 3 agents (benefits-advisor, underwriting-and-actuarial-analyst, enrollment-and-compliance-lead) for the group-benefits domain: plan design across medical / dental / vision / life / disability, funding choices (fully-insured vs self-funded /... |
