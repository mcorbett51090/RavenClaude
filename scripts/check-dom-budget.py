...
RATCHET = {
    DASHBOARD: [
        ...
        (
            "Routine reserve tab (routine token reserve PR 2, core 0.326.0)",
            6383,
            "New Activity sub-page 'Routine reserve': the sidebar ds-sub link, the "
            "tab-btn, and the panel-reserve section shell. MEASURED, not estimated: "
            "6,380 -> 6,383 (+3). Tail lifted in lockstep to stay monotonic. Zero slack.",
        ),
    ],
    INDEX: [
        (
        ...
        (
            "Routine reserve tab (routine token reserve PR 2, core 0.326.0)",
            7269,
            "same Routine reserve tab-btn + ds-sub link + panel shell folded into "
            "the portal. MEASURED, not estimated, on BOTH surfaces after the edit: "
            "7,266 -> 7,269 (+3). Tail lifted in lockstep to stay monotonic. Zero slack.",
        ),
    ],
}
