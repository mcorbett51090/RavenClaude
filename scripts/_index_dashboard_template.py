...
<!-- GENERATED by scripts/generate-index-dashboard.py — do not edit by hand.
     Edit scripts/_index_dashboard_template.py (this page's shell) or
     scripts/generate-dashboards.py (the folded dashboard payload) and
     regenerate. The freshness gate fails CI on drift, so a hand-edit here
     is silently reverted on the next run. -->
<html lang="en">
  <head>
    <meta charset="utf-8" />
