...
PY
    ...
    281)
      ...
      ;;
    282)
      echo "── Gate 282: skill-index freshness (per-gate run) ──"
      rc=0
...
echo "── Gate 282: skill-index freshness (FORGE plan dynamic-skill-context, P0) ──"
...
if command -v python3 >/dev/null 2>&1; then
  ...
  _skip_or_fail "Gate 282 (skill-index freshness)" python3
fi
