...
PY
    ...
    263)
      ...
      ;;
    264)
      echo "── Gate 264: prompt-optimizer structural regression subset (per-gate run) ──"
...
echo
echo "── Gate 264: prompt-optimizer structural regression subset (Phase 9) ────────"
...
# invoked from this dispatcher or from this main sequence. ⛔ Gate 264 itself
