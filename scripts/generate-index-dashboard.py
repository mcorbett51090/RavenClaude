...
CATEGORIES: list[dict] = [
    {
        ...
        "label": "Core & Delivery",
        "icon": "hub",
        "blurb": "The domain-neutral foundation every plugin builds on — the Team "
        "Lead and protocols — plus product, project, and process delivery.",
        "plugins": [
            "ravenclaude-core",
            "project-management",
            "product-management",
    ...
    },
    {
        ...
        "icon": "git",
        "blurb": "Backend, frontend, mobile, databases, APIs, QA, performance, "
        "embedded/IoT, games, auth, blockchain, and search relevance.",
        "plugins": [
            "backend-engineering",
    ...
    },
    {
        ...
        "icon": "rocket",
        "blurb": "AWS / Azure / GCP, Kubernetes, Terraform, CI/CD, internal "
        "developer platforms, observability/SRE, and cloud-cost FinOps.",
        "plugins": [
            "aws-cloud",
            "azure-cloud",
            "gcp-cloud",
    ...
    },
    {
        ...
        "icon": "chart",
        "blurb": "Data platforms, streaming, data science, analytics engineering, "
        "statistics, BI/Tableau, experimentation, and data governance.",
        "plugins": [
            "data-platform",
    ...
    },
    {
        ...
        "icon": "sparkle",
        "blurb": "Building with Claude, model-selection guidance across coding "
        "tools, RAG systems, and ML engineering.",
        "plugins": [
    ...
    },
    {
        ...
        "icon": "shield",
        "blurb": "Application/cloud security engineering, cybersecurity GRC, the "
        "regulatory lane, and ESG / sustainability reporting.",
        "plugins": [
    ...
    },
    {
        ...
        "label": "Microsoft & Enterprise Platforms",
        "icon": "windows",
        "blurb": "Power Platform, Fabric, Graph, M365 Copilot, and Salesforce "
        "delivery craft.",
        "plugins": [
            "power-platform",
            "microsoft-fabric",
    ...
    },
    {
        ...
        "icon": "palette",
        "blurb": "Web design & build, accessibility, technical writing, "
        "localization / i18n, and film & video production.",
        "plugins": [
            "web-design",
    ...
    {
        "id": "sales-marketing-cx",
        "label": "Sales, Marketing & CX",
        "icon": "sliders",
        "blurb": "RevOps, marketing operations, customer-success analytics, "
        "support / CX operations, and DTC e-commerce.",
        "plugins": [
            "sales-revops",
    ...
    },
    {
        ...
        "label": "People & HR",
        "icon": "hub",
        "blurb": "People operations / HR and staffing operations.",
        "plugins": ["people-operations-hr", "staffing-operations"],
    },
    {
        "id": "finance-fintech-insurance",
        "label": "Finance, Fintech & Insurance",
        "icon": "building",
        "blurb": "Corporate finance / FP&A, accounting, payments engineering, "
        "wealth management, mortgage lending, and life/health & P&C insurance.",
        "plugins": [
            "finance",
    ...
    },
    {
        ...
        "icon": "book",
        "blurb": "Behavioral health, clinical trials, dental, hospice, medical "
        "revenue cycle, pharmacy, senior care, and veterinary practice.",
        "plugins": [
    ...
    },
    {
        ...
        "icon": "building",
        "blurb": "Commercial real estate, property management, architecture / AEC, "
        "general contracting, and skilled trades.",
        "plugins": [
    ...
    {
        "id": "industrial-supply-energy",
        "label": "Industrial, Supply Chain & Energy",
        "icon": "sliders",
        "blurb": "Manufacturing, supply-chain planning, procurement, fleet & "
        "freight logistics, field service, renewable energy, and precision ag.",
        "plugins": [
    ...
    {
        "id": "retail-hospitality-consumer",
        "label": "Retail, Hospitality & Consumer",
        "icon": "chart",
        "blurb": "Retail store operations, restaurants, hotels / hospitality, "
        "automotive dealerships, and cannabis operations.",
        "plugins": [
    ...
    {
        "id": "public-education-nonprofit",
        "label": "Public Sector, Education & Nonprofit",
        "icon": "book",
        "blurb": "GovTech / public sector, K-12 school administration, EdTech "
        "partner success, and nonprofit fundraising.",
        "plugins": [
    ...
    },
    {
        ...
        "icon": "shield",
        "blurb": "Legal operations / CLM and small-firm legal practice.",
        "plugins": ["legal-ops-clm", "legal-small-firm"],
    },
    {
        "id": "specialized",
        "label": "Specialized",
        "icon": "sparkle",
        "blurb": "Newly added plugins not yet sorted into a category.",
        "plugins": [],
    },
]
