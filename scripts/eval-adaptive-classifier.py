...
def self_test() -> int:
    ...
    baseline = RunMetrics(
        ...
        input_tokens=dict.fromkeys(PHASES_TO_REPORT, 100_000),
    ...
    adaptive = RunMetrics(
        ...
        cache_read_input_tokens=dict.fromkeys(PHASES_TO_REPORT, 20_000),
        input_tokens=dict.fromkeys(PHASES_TO_REPORT, 100_000),
        cache_creation_input_tokens=dict.fromkeys(PHASES_TO_REPORT, 5_000),
