#!/usr/bin/env python3
"""Packaging move; canonical path is plugins/ravenclaude-core/scripts/premise-gate.py.

Thin compatibility shim so `python3 scripts/premise-gate.py` keeps working.
"""
