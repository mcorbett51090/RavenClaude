...
> Verified 2026-06-05 (web): the `@modelcontextprotocol/server-postgres` deprecation + archival + the Datadog SQL-injection finding (securitylabs.datadoghq.com; modelcontextprotocol/servers-archived); Postgres MCP Pro's read/write + restricted access modes (crystaldba/postgres-mcp README); MCP Toolbox v1.6.0 (re-verified 2026-07-08 via [github.com/googleapis/mcp-toolbox releases](https://github.com/googleapis/mcp-toolbox/releases/tag/v1.6.0); was v0.28.0 at the 2026-06-05 review) + Claude Code client support (googleapis/mcp-toolbox; googleapis.github.io/genai-toolbox). Package names, versions, archival status, and flag names are volatile — re-confirm at use.
