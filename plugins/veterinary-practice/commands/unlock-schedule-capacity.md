...
## Output
A capacity read, an appointment-template redesign, a support-ratio recommendation, and the revenue unlock. See [`../skills/unlock-schedule-capacity/SKILL.md`](../skills/unlock-schedule-capacity/SKILL.md).
