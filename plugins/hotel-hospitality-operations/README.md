...
| Surface | Contents |
|---|---|
| **agents** | `hotel-operations-lead`, `revenue-management-analyst`, `labor-productivity-specialist`, `guest-experience-specialist` |
| **skills / commands** | `read-revpar` · `compare-channels` · `read-booking-pace` · `size-labor` · `link-experience-revenue` |
| **knowledge bank** | KPI glossary · unit economics · 2025–2026 context · Mermaid decision trees |
| **templates** | scorecard · exec readout · revpar-channel.md · labor-productivity.md |
| **an advisory hook** | flags anti-patterns (unbaselined metric, unsourced benchmark, guest PII) in generated deliverables |
