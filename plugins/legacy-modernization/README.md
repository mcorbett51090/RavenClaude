...
Plus **skills**, a **knowledge bank** (Mermaid decision trees + a dated 2026 capability map + a pattern-catalog reference), **best-practices**, **templates**, **commands**, and **an advisory hook**.
