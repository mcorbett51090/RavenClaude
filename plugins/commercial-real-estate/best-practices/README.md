# Commercial Real Estate best-practice docs

Named, citable rules for the `commercial-real-estate` plugin's 4 specialist agents and any consultant running a commercial real estate engagement. Each file is one rule — read, applied, and cited whole. Grounded in this plugin's `knowledge/` bank and its agent constitutions.
...
| Doc | Status | Use when |
|---|---|---|
| [`underwrite-to-in-place-noi-not-pro-forma.md`](./underwrite-to-in-place-noi-not-pro-forma.md) | Absolute rule | Any commercial real estate deliverable where this question is in play — read, applied, and cited whole. |
| [`cap-rate-and-discount-rate-are-not-interchangeable.md`](./cap-rate-and-discount-rate-are-not-interchangeable.md) | Absolute rule | Any commercial real estate deliverable where this question is in play — read, applied, and cited whole. |
| [`always-separate-the-spread.md`](./always-separate-the-spread.md) | Absolute rule | Any commercial real estate deliverable where this question is in play — read, applied, and cited whole. |
| [`vacancy-is-bifurcated-never-quote-it-without-the-tier.md`](./vacancy-is-bifurcated-never-quote-it-without-the-tier.md) | Pattern | Any commercial real estate deliverable where this question is in play — read, applied, and cited whole. |
| [`net-effective-rent-is-the-real-number-not-face-rent.md`](./net-effective-rent-is-the-real-number-not-face-rent.md) | Pattern | Any commercial real estate deliverable where this question is in play — read, applied, and cited whole. |
