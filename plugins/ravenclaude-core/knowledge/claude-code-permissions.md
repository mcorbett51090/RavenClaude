...
| `PreModelSwitch` / `PostModelSwitch` | Before / after a mid-session model switch (v2.1.251, 2026-08-28) `[verify-at-use]`. | Block, confirm, or annotate a model switch for controlled rollouts. |
