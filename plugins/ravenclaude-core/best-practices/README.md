...
| [`claude-md-imports-organize-they-dont-shrink-context.md`](./claude-md-imports-organize-they-dont-shrink-context.md) | Pattern | A `CLAUDE.md` is growing large — deciding how to trim baseline context (`@import` is dedup, not budget; path-scoped `.claude/rules/` and skills are the real levers). |
