...
| [`scope-the-reviewer-to-correctness-or-it-manufactures-work.md`](./scope-the-reviewer-to-correctness-or-it-manufactures-work.md) | Pattern | Convening any panel, tribunal seat, or reviewer sub-agent — scope it to correctness/requirement gaps (and let an implementer triage findings) so a gap-finding reviewer doesn't manufacture work the implementer then over-engineers. |
