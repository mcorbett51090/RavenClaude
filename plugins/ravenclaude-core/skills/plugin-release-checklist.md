...
- [`audit-ci-gates.md`](./audit-ci-gates.md) — step 9's underlying meta-test.
- [`knowledge-file-staleness-sweep.md`](./knowledge-file-staleness-sweep.md) — the pre-release knowledge-freshness gate that pairs with this checklist.
