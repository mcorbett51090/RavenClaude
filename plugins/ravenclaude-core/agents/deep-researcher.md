...
maxTurns: 60
effort: high
# NOTE: deliberately NO `memory:` — a researcher accumulates domain/vendor facts, which would violate the domain-neutral house rule and risk leaking consumer-engagement specifics across runs.
