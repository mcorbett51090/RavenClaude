...
|---|---|
| **Coding agent** (Claude/Codex agents on github.com) | Claude: **Fable 5 (export controls LIFTED 2026-06-30, access restoring from 2026-07-01 — see bullet below; GA 2026-06-09)**, **Opus 4.8 (GA 2026-05-28)**, **Sonnet 5 (GA in Copilot 2026-06-30, gradual rollout)**, Sonnet 4.6, Opus 4.6, Sonnet 4.5, Opus 4.5 · Codex: GPT-5.2-Codex, GPT-5.3-Codex, GPT-5.4 |
...
| **Org control** | **Model rules** target/restrict models to organizations (Changelog 2026-05-26) · **Enterprise admins can set `model=auto` as the default** for new conversations ([Changelog 2026-07-01](https://github.blog/changelog/2026-07-01-enterprises-can-default-to-auto-model-selection/)) `[verify-at-use — dated 2026-07-08]` |
...
| **GPT-5.6 Sol** | Flagship — complex reasoning / agentic runs | **NEW generation**; limited preview via API + Codex from ~2026-06-26, public launch announced **2026-07-09** — verify selectable in your CLI. In the 5.6 naming scheme the number is the generation and **Sol/Terra/Luna are durable capability tiers**. [OpenAI](https://openai.com/index/previewing-gpt-5-6-sol/) `[verify-at-use — dated 2026-07-08]` |
| GPT-5.6 Terra | Balanced / high-volume business tier — ~GPT-5.5 quality at lower cost | preview `[verify-at-use — dated 2026-07-08]` |
| GPT-5.6 Luna | Fast / cheapest tier — latency-dominated / inline | preview `[verify-at-use — dated 2026-07-08]` |
