...
**Last reviewed:** 2026-07-05 (**Claude Sonnet 5 GA in GitHub Copilot 2026-06-30** — `claude-sonnet-5`, Pro/Pro+/Max/Business/Enterprise, gradual picker rollout, ZDR; the Claude-platform default for Sonnet-tier work, see the 2026-07-05 sweep note. Carried forward: Fable 5 / Mythos 5 export controls **LIFTED 2026-06-30**, access restoring from 2026-07-01 — re-verify per-surface callability before routing; Fable 5 free-inclusion window 2026-06-09..2026-06-22 **elapsed** — restored access bills usage credits; Codex GPT-5.3-Codex/5.2 deprecation + MAI-Code-1-Flash; Grok Build 2026-06-17) · **Confidence:** medium — these three vendors ship **weekly-to-monthly**, faster than the Claude platform; treat this as the freshness anchor the Researcher sweep re-dates. Every numeric / availability claim carries a retrieval date — **verify against the cited primary source before quoting it to anyone.**
...
|---|---|
| **Coding agent** (Claude/Codex agents on github.com) | Claude: **Fable 5 (export controls LIFTED 2026-06-30, access restoring from 2026-07-01 — see bullet below; GA 2026-06-09)**, **Opus 4.8 (GA 2026-05-28)**, **Sonnet 5 (GA in Copilot 2026-06-30; gradual picker rollout — may not appear yet)**, Sonnet 4.6, Opus 4.6, Sonnet 4.5, Opus 4.5 · Codex: GPT-5.2-Codex, GPT-5.3-Codex, GPT-5.4 |
...
- **Claude Sonnet 5 is GA in Copilot** ([Changelog 2026-06-30](https://github.blog/changelog/2026-06-30-claude-sonnet-5-is-generally-available-for-github-copilot/); retrieved 2026-07-05) — `claude-sonnet-5`, Anthropic's new balanced Sonnet-tier default (drop-in upgrade for Sonnet 4.6, largest gains in coding + agentic work; "near Opus-level agentic power" per secondary coverage `[verify-at-use — single-source/vendor framing]`). Available on **Copilot Pro / Pro+ / Max / Business / Enterprise**; **selectable in the model picker with a gradual rollout** — it may not appear on your tenant immediately. Runs under **Zero Data Retention (ZDR)**, like other Sonnet models in Copilot. On the Claude platform itself it is `$3 / $15` per Mtok (**intro `$2 / $10` through 2026-08-31**) and carries a **new tokenizer (~+30% tokens vs Sonnet 4.6)** — for Copilot's own request/premium-request accounting confirm the live multiplier on your tenant. The Copilot changelog 403s automated fetch — read via `WebSearch` + cross-referenced (the file's accepted "primary 403 → cross-reference" pattern; the platform.claude.com Sonnet 5 doc *did* fetch cleanly 2026-07-05 and grounds the model-level facts). `[verify-at-use — surface/plan-specific; gradual rollout]`
...
> **Sweep note (2026-07-05):** **Claude Sonnet 5 (`claude-sonnet-5`) went GA 2026-06-30** — Anthropic's new balanced Sonnet-tier default (drop-in upgrade for Sonnet 4.6 at the same `$3/$15` standard price; intro `$2/$10` through 2026-08-31) and **now the default model in Claude Code**. It is **GA in GitHub Copilot the same day** ([Changelog 2026-06-30](https://github.blog/changelog/2026-06-30-claude-sonnet-5-is-generally-available-for-github-copilot/)) on Pro/Pro+/Max/Business/Enterprise with a **gradual picker rollout** (ZDR). Added to the coding-agent table row + a Copilot bullet above. Two behavior changes an agent user should know: **adaptive thinking is on by default** (manual extended thinking → 400) and a **new tokenizer bills ~30% more tokens** for the same text than Sonnet 4.6. Model-level facts grounded on the first-party [Sonnet 5 doc](https://platform.claude.com/docs/en/about-claude/models/whats-new-sonnet-5) (fetched cleanly 2026-07-05); Copilot availability via the changelog (403 automated fetch → `WebSearch`) + secondaries. This plugin covers Claude models **only as they appear in the Copilot picker** (house opinion #8); the authoritative Claude lineup lives in [`../../claude-app-engineering/knowledge/model-selection-and-2026-capability-map.md`](../../claude-app-engineering/knowledge/model-selection-and-2026-capability-map.md). `[verify-at-use — gradual rollout; dated 2026-07-05]`
>
