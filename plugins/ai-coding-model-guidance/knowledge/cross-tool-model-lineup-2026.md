...
|---|---|
| **Coding agent** (Claude/Codex agents on github.com) | Claude: **Fable 5 (export controls LIFTED 2026-06-30, access restoring from 2026-07-01 — see bullet below; GA 2026-06-09)**, **Opus 4.8 (GA 2026-05-28)**, **Sonnet 5 (GA in Copilot 2026-06-30; retrieved 2026-07-06 `[verify-at-use]`)**, Sonnet 4.6, Opus 4.6, Sonnet 4.5, Opus 4.5 · Codex: GPT-5.2-Codex, GPT-5.3-Codex, GPT-5.4 |
...
> **Sweep note (2026-07-06):** **Claude Sonnet 5 went GA in GitHub Copilot on 2026-06-30** ([GitHub Changelog](https://github.blog/changelog/2026-06-30-claude-sonnet-5-is-generally-available-for-github-copilot/); selectable in the model picker for Copilot Pro / Pro+ / Max / Business / Enterprise across IDEs + the Copilot CLI v1.0.67) — added to the coding-agent table row as the current Sonnet-class Claude option, superseding Sonnet 4.6. Sonnet 5 (`claude-sonnet-5`, GA 2026-06-30, 1M context / 128K output, intro $2/$10 per Mtok through 2026-08-31) is a **Claude** model — its capability/right-sizing guidance is owned by the sibling `claude-app-engineering` capability map; **this file tracks only its Copilot-picker availability** (the row already lists Claude SKUs as Copilot-availability facts, so this is in-scope). Also spotted this sweep, **not yet folded in**: **Kimi K2.7 Code** — Copilot's first selectable open-weight model (fast/low-cost tier) — a candidate for the cheapest-fast tier next sweep. `[verify-at-use — dated 2026-07-06]`
>
