...
**Last reviewed:** 2026-06-21 (Codex GPT-5.3-Codex/5.2 deprecation + MAI-Code-1-Flash; Fable 5 suspension carried from 2026-06-13) · **Confidence:** medium — these three vendors ship **weekly-to-monthly**, faster than the Claude platform; treat this as the freshness anchor the Researcher sweep re-dates. Every numeric / availability claim carries a retrieval date — **verify against the cited primary source before quoting it to anyone.**
...
- **Codex deprecations (sweep 2026-06-21):** **GPT-5.3-Codex and GPT-5.2/5.2-Codex are deprecated** — new API requests end **2026-06-30**, full shutdown 2026-12-31. GPT-5.5 is the migration target (and the long-autonomous-run pick now that 5.3-Codex is going). Flagged here like the `grok-code-fast-1` retirement so a consumer pinning a sunset id sees it. `[verify-at-use — dated 2026-06-21]`
...
> **Sweep note (2026-06-21):** two non-Claude churns folded in since the 2026-06-13 review. (1) **OpenAI GPT-5.3-Codex and GPT-5.2/5.2-Codex are deprecated** — new API requests end **2026-06-30**, full shutdown 2026-12-31; flagged in the Codex table like the `grok-code-fast-1` retirement, with GPT-5.5 as the migration target (and the long-autonomous-run pick). (2) **MAI-Code-1-Flash** (Microsoft small coding model) went broadly available across Copilot surfaces **2026-06-18** — added to the cheapest-fast tier. The Fable 5 suspension below (2026-06-13) is unchanged and still current as of this review. `[verify-at-use — dated 2026-06-21]`
>
