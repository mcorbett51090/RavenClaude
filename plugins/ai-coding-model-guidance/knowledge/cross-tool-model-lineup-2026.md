...
> **Sweep note (2026-07-07):** **Claude Sonnet 5 went GA in GitHub Copilot on 2026-06-30** ([GitHub Changelog 2026-06-30](https://github.blog/changelog/2026-06-30-claude-sonnet-5-is-generally-available-for-github-copilot/)) — in the model picker on a **gradual rollout** to **Copilot Pro / Pro+ / Max / Business / Enterprise**, under **Zero Data Retention**; corroborated via WebSearch (github.blog 403s automated fetch) across AlphaSignal and the VS Code release channels. Added to the Copilot coding-agent snapshot row above (newest Sonnet SKU ahead of Sonnet 4.6, which coexists during the rollout). Surface-scope per house opinion #3: **verified for the coding-agent/picker surface; re-verify the mobile picker (row above) and per-tenant/plan availability before quoting.** Sonnet 5's Claude-side **right-sizing, specs, and pricing are deliberately NOT duplicated here** — this is the non-Claude ecosystem file; they live in the sibling [`../../claude-app-engineering/knowledge/model-selection-and-2026-capability-map.md`](../../claude-app-engineering/knowledge/model-selection-and-2026-capability-map.md) (house opinion #8 seam / single-source-of-truth). **Carry-forward (unchanged this sweep):** the vendor-neutral decision tree's `Sonnet-class` balanced-default anchor **stays a class label** — it is not a SKU and does not churn with the picker; Fable 5 restoration remains in-progress per the 2026-07-01 note below; Codex GPT-5.3/5.2 deprecation and Grok Build carry forward. `[verify-at-use — surface/plan-specific; dated 2026-07-07]`
>
