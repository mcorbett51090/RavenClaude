...
**Last reviewed:** 2026-06-17 (Grok Build / `grok-build-0.1` verified — see sweep note; Fable 5 suspension 2026-06-12 — see sweep note) · **Confidence:** medium — these three vendors ship **weekly-to-monthly**, faster than the Claude platform; treat this as the freshness anchor the Researcher sweep re-dates. Every numeric / availability claim carries a retrieval date — **verify against the cited primary source before quoting it to anyone.**
