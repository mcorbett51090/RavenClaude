...
**Last reviewed:** 2026-06-21 · **Confidence:** medium — these three vendors ship **weekly-to-monthly**, faster than the Claude platform; treat this as the freshness anchor the Researcher sweep re-dates. Every numeric / availability claim carries a retrieval date — **verify against the cited primary source before quoting it to anyone.**
...
## ⚠️ BREAKING (sweep 2026-06-21): Claude Fable 5 / Mythos 5 globally suspended

**As of 2026-06-12, Claude Fable 5 and Claude Mythos 5 are SUSPENDED across every surface — re-verify before relying.** A US-government export-control directive (national-security authority) ordered Anthropic to suspend all access to Fable 5 and Mythos 5 for any foreign national worldwide; unable to enforce that selectively in real time, Anthropic **disabled both models for all customers**. The suspension hit **GitHub Copilot (pulled the same day), AWS Bedrock, Google Cloud, Microsoft Foundry, Snowflake, Box, and the direct Claude APIs** simultaneously. **All other Claude models are unaffected.** Anthropic says it believes this is a misunderstanding and is "working to restore access as soon as possible," so this is a **fast-moving** situation, not a permanent retirement: every Fable-5/Mythos-5 row below that reads "GA / selectable / free-through-2026-06-22" is **superseded by this suspension and must be re-verified at use** — the dated GA (2026-06-09) record is kept for the honest GA-then-suspended timeline, not as a current-availability claim. `[verify-at-use — fast-moving; suspension may be lifted]` Sources (corroborated across multiple this-session — Anthropic news + the [Anthropic statement](https://www.anthropic.com/news/claude-fable-5-mythos-5), GitHub Changelog/community, Azure blog, secondaries): retrieved 2026-06-21.

> **Closed-world note:** Fable 5 / Mythos 5 remain *named* in the verified lineup (they existed and may return) — but their **availability** is now "suspended as of 2026-06-12," not "GA." Scope every Fable-5 answer to that.
...
flowchart TD
    ...
    Q2 -->|Yes| AGENT[Coding-agent tier<br/>Copilot: coding-agent models · Codex: GPT-5.5 / GPT-5-Codex GPT-5.3-Codex deprecated 2026-06 · Grok: flagship long-context]
...
|---|---|
| **Coding agent** (Claude/Codex agents on github.com) | Claude: ~~Fable 5 (GA 2026-06-09)~~ **⚠️ SUSPENDED 2026-06-12 — see top banner**, **Opus 4.8 (GA 2026-05-28)**, Sonnet 4.6, Opus 4.6, Sonnet 4.5, Opus 4.5 · Codex: GPT-5.4, **GPT-5.5** (newest; start-here) — ~~GPT-5.2-Codex, GPT-5.3-Codex~~ **deprecated 2026-06 (new API requests end 2026-06-30, full shutdown 2026-12-31)** |
| **Cloud agent — fast/cost-efficient tier** | Claude Haiku 4.5, GPT-5.4-mini, **MAI-Code-1-Flash** (Microsoft small coding model; broadly available 2026-06-18) |
...
| Model | Use for | Notes |
|---|---|---|
| **GPT-5.5** | **Start here for most tasks** — newest frontier; complex coding, tool use, multi-step follow-through; **also the recommended pick for long autonomous agentic runs** now that GPT-5.3-Codex is deprecated | More intelligent **and** more token-efficient than GPT-5.4 |
...
| ~~GPT-5.2 / GPT-5.2-Codex~~ | ~~prior generation~~ | **⚠️ DEPRECATED 2026-06** — same sunset timeline as GPT-5.3-Codex (new requests end 2026-06-30, shutdown 2026-12-31); already removed from ChatGPT 2026-06-12. Migrate to GPT-5.5/5.4. `[verify-at-use — dated 2026-06-21]` |
...
> **Sweep note (2026-06-21):** three fast-churn changes landed since the 2026-06-11 review and are folded in above. (1) **Claude Fable 5 + Mythos 5 were globally SUSPENDED on 2026-06-12** under a US export-control directive — disabled for all customers across Copilot/Bedrock/Google Cloud/Foundry/Snowflake/Box/Claude API; the prior "GA / free-through-2026-06-22" framing is **superseded in place** (kept as the dated GA-then-suspended record, not struck) and re-marked `[verify-at-use — may be restored]`, since Anthropic says it is working to restore access. This also moots the **2026-06-10 free-through-2026-06-22 caveat below** — left visible as the dated timeline, not deleted. (2) **OpenAI GPT-5.3-Codex and GPT-5.2/5.2-Codex are deprecated** (new API requests end **2026-06-30**, full shutdown 2026-12-31) — flagged in the Codex table like the `grok-code-fast-1` retirement, with GPT-5.5 as the migration target. (3) **MAI-Code-1-Flash** (Microsoft small coding model) went broadly available across Copilot surfaces **2026-06-18** — added to the cheapest-fast tier. Grok: no material change this sweep (Grok 3 pulled→4.3 redirect and Databricks availability are non-load-bearing here). Patch-bumped accordingly.
>
