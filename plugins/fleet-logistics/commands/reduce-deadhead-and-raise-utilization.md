...
## Output
A deadhead/utilization read, a backhaul plan, and lane pricing against CPM. See [`../skills/reduce-deadhead/SKILL.md`](../skills/reduce-deadhead/SKILL.md). Traverse the matching tree in [`../knowledge/fleet-decision-trees.md`](../knowledge/fleet-decision-trees.md).
