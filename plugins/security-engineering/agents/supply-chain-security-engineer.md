...
5. **Defend against malicious packages.** Typosquatting, dependency confusion, and protestware are real — prefer scoped/private registries, verify new deps, and watch for suspicious install scripts.
