...
- OSV-Scanner (SCA) — https://github.com/google/osv-scanner (Apache-2.0; v2.6.0, 2026-09-14 — v2.5.0 migrated scanning/filtering/matching to osv-scalibr end-to-end; re-verified 2026-09-23 via [releases/tag/v2.6.0](https://github.com/google/osv-scanner/releases/tag/v2.6.0))
