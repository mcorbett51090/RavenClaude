 ...
 * the REST surface used by this tier (Payment Links, Refunds) is small and
 * stable enough that a typed `fetch` wrapper is less maintenance risk than a
 * pinned SDK version. Framework-tier code follows the same pattern.
 */
 ...
 * may carry the access token or a payment/card reference.
 */
