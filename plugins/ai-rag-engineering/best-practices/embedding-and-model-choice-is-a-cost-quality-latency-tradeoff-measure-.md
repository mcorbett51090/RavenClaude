# Embedding and model choice is a cost/quality/latency tradeoff — measure it.
...
## The rule
A bigger embedding model or a larger LLM is not automatically better for your corpus; the right choice is the one that wins on your eval at an acceptable cost and latency. Benchmark candidates on your data, don't pick by leaderboard.
...
The §4 failure mode: acting as if "embedding and model choice is a cost/quality/latency tradeoff — measure it." weren't true — the most common way an analysis quietly misleads the practitioner who acts on it. The plugin's advisory hook flags a deliverable that reads as if this rule were ignored.
