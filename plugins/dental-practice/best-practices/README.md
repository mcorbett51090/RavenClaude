# Dental Practice best-practice docs

Named, citable rules for the `dental-practice` plugin's 4 specialist agents and any consultant running a dental practice engagement. Each file is one rule — read, applied, and cited whole. Grounded in this plugin's `knowledge/` bank and its agent constitutions.
...
| Doc | Status | Use when |
|---|---|---|
| [`overhead-is-the-master-margin-number.md`](./overhead-is-the-master-margin-number.md) | Absolute rule | Any dental practice deliverable where this question is in play — read, applied, and cited whole. |
| [`collections-not-production-pay-the-bills.md`](./collections-not-production-pay-the-bills.md) | Absolute rule | Any dental practice deliverable where this question is in play — read, applied, and cited whole. |
| [`case-acceptance-is-presentation-not-price.md`](./case-acceptance-is-presentation-not-price.md) | Absolute rule | Any dental practice deliverable where this question is in play — read, applied, and cited whole. |
| [`production-per-hour-is-the-capacity-lens.md`](./production-per-hour-is-the-capacity-lens.md) | Pattern | Any dental practice deliverable where this question is in play — read, applied, and cited whole. |
| [`the-hygiene-department-is-a-profit-engine-not-a-loss-leader.md`](./the-hygiene-department-is-a-profit-engine-not-a-loss-leader.md) | Pattern | Any dental practice deliverable where this question is in play — read, applied, and cited whole. |
