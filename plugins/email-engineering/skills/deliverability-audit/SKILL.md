...
3. **Reputation** — is the domain/IP **warmed**? Check Google Postmaster domain reputation. A new domain or a volume spike reads as spam regardless of auth. Remedy: warm-up ramp, reduce volume, isolate the bad stream.
