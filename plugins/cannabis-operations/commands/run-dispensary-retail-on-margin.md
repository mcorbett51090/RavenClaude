...
You are running `/cannabis-operations:run-dispensary-retail-on-margin` for `$ARGUMENTS`. Run it the way the team's specialists would — applying the house opinions in [`../CLAUDE.md`](../CLAUDE.md) §3.

## Steps (traverse top-to-bottom; do not skip)
1. Read category margin — Gross margin by category against the 280E-squeezed target (§3 #4).
2. Read basket and UPT — Basket size and units-per-transaction, by budtender.
3. Read turns — Inventory turns by category, flagging aged/perishable flower (§3 #5).
