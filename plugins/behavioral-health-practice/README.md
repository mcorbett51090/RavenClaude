...
| Surface | Contents |
|---|---|
| **agents** | `behavioral-health-practice-lead`, `intake-access-analyst`, `clinical-documentation-compliance-specialist`, `payer-billing-specialist` |
| **skills / commands** | `manage-no-show-flow` · `shorten-access-time` · `audit-documentation-billing` · `size-caseload` · `model-payer-mix` |
| **knowledge bank** | KPI glossary · unit economics · 2025–2026 context · Mermaid decision trees |
| **templates** | scorecard · exec readout · no-show-recovery-plan.md · payer-mix-margin-model.md |
