...
You are running `/game-development:design-the-core-loop` for `$ARGUMENTS`. Run it the way the team's specialists would — applying the house opinions in [`../CLAUDE.md`](../CLAUDE.md) §3.

## Steps (traverse top-to-bottom; do not skip)
1. Define the loop — The moment-to-moment action and its reward (§3 #2).
2. Add the session loop — What brings the player back this session and next.
3. Layer the meta — Progression and meta on top of a proven loop.
