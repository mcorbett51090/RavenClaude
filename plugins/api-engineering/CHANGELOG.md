...
- **3-doc knowledge bank** (retrieval-dated 2026-06-04) with 7 Mermaid decision trees (paradigm selection, versioning, pagination, OAuth2 grant, OWASP API control map, test-type selection, gateway build-vs-buy) + a dated 2026 spec capability map.
- **~18 best-practices** across design / build / secure / test / operate, one named rule per file.
- **6 templates:** contract-first OpenAPI skeleton, Problem Details catalog, Spectral style-guide ruleset, API design-review checklist, deprecation/sunset plan.
