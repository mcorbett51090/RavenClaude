...
- **best-practices/** — ~18 named, citable rules across design / build / secure / test / operate, surfaced in the marketplace repo-guide + dashboard Guidance tab.
- **templates/** — contract-first OpenAPI skeleton, Problem Details catalog, Spectral style-guide ruleset, API design-review checklist, deprecation/sunset plan.
