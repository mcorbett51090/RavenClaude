# Precision Agriculture best-practice docs

Named, citable rules for the `precision-agriculture` plugin's 4 specialist agents and any consultant running a precision agriculture engagement. Each file is one rule — read, applied, and cited whole. Grounded in this plugin's `knowledge/` bank and its agent constitutions.
