...
- **⚠️ Reserved VM Instances retired for select legacy series (new purchase/renewal only; existing honored to term), effective 2026-07-01 (verified 2026-07-09):** RIs on a set of legacy VM series can **no longer be newly purchased or renewed** — 1-year: Av2, Amv2, Bv1, D/Ds, Dv2/Dsv2, F/Fs/Fsv2, G/Gs, Ls/Lsv2; 1-year **and** 3-year: Dv3/Dsv3, Ev3/Esv3. **Existing RIs are honored to end-of-term.** This is **not** a blanket "Azure RIs retired" — it is scoped to these legacy SKUs. Recommended path: **Azure savings plan for compute**, or modernize to current SKUs. [Transition guide for retired Azure Reserved VM Instances](https://learn.microsoft.com/azure/cost-management-billing/reservations/manage-legacy-vm-reservations-after-july-1-2026) `[verify-at-use — exact affected-series list; billing construct]`
