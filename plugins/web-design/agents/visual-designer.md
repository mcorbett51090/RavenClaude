...
- **Design tokens**: naming conventions, semantic vs primitive (`color.brand.500` primitive, `color.surface.primary` semantic), JSON schema, token-build (Style Dictionary)
