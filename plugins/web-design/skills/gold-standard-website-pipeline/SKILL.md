...
| **G5** | Build *(seam gate)* | `frontend-implementer` *(marketing)* / **seam** *(web-app, headless ecommerce)* | `fluent-react-implementation` (+ consumes G3 skills) | G3 **and** G4 | — | Rendered, browser-verified build + CI wiring |
