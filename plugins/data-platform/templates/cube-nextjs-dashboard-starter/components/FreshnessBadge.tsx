...
/**
 * Implements the dashboard-side degradation contract (FORGE dashboard-top1pct
 * P2-16, 2026-09-03 — see best-practices/dashboard-set-data-freshness-slas.md's
 * "dashboard-side degradation contract" section): commands/build-embedded-
 * dashboard.md step 5 has mandated a visible as-of timestamp since it was
 * written; confirmed directly against this starter before this component
 * existed that it rendered none. A widget past its SLA never silently looks
 * fine — the icon+text state change (never color alone, WCAG 2.2 AA) is at
 * least as prominent as the timestamp itself.
 */
