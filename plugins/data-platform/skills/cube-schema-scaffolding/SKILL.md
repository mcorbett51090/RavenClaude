...
Cube's `securityContext` is populated from the JWT claims passed in the `Authorization: Bearer <jwt>` header. The JWT issuer ([`../jwt-embed-issuance/SKILL.md`](../jwt-embed-issuance/SKILL.md)) must include `tenant_id` in its claims.
...
- Skill: [`../jwt-embed-issuance/SKILL.md`](../jwt-embed-issuance/SKILL.md) — JWT claims that populate `securityContext`
- Skill: [`../rls-policy-authoring/SKILL.md`](../rls-policy-authoring/SKILL.md) — defense-in-depth RLS on the DB behind Cube
