...
- **Missing `tenant_id` in `dimensions`** — pre-agg shared across tenants; cross-tenant leak. See [`../cube-schema-scaffolding/SKILL.md`](../cube-schema-scaffolding/SKILL.md).
...
1. **dbt incremental model** with `materialized='incremental'` → managed table, dbt handles the delta logic (preferred — see [`../dbt-project-scaffolding/SKILL.md`](../dbt-project-scaffolding/SKILL.md))
...
- Skill: [`../cube-schema-scaffolding/SKILL.md`](../cube-schema-scaffolding/SKILL.md) — the `securityContext` + pre-agg authoring layer
- Skill: [`../dbt-project-scaffolding/SKILL.md`](../dbt-project-scaffolding/SKILL.md) — dbt incremental models as the materialized-view alternative
- Skill: [`../data-quality-tests/SKILL.md`](../data-quality-tests/SKILL.md) — row-count drift tests catching silent pre-agg breaks
- Skill: [`../rls-policy-authoring/SKILL.md`](../rls-policy-authoring/SKILL.md) — tenant-aware pre-aggs respect RLS by including `tenant_id` in dimensions
