...
- Skill: [`../stack-selection/SKILL.md`](../stack-selection/SKILL.md) — Case A/B/C/D names the engagement shape first
- Skill: [`../rls-policy-authoring/SKILL.md`](../rls-policy-authoring/SKILL.md) — what to ship alongside the schema
