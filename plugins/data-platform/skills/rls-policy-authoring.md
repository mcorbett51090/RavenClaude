...
- Skill: [`./jwt-embed-issuance.md`](jwt-embed-issuance.md) — where the `tenant_id` claim originates
- Skill: [`./cube-schema-scaffolding.md`](cube-schema-scaffolding.md) — Cube semantic-layer scope rules
