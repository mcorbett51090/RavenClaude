...
- Skill: [`./jwt-embed-issuance.md`](jwt-embed-issuance.md) — the JWT that travels through the boundary
- Skill: [`./rls-policy-authoring.md`](rls-policy-authoring.md) — what the JWT claim ultimately enforces
