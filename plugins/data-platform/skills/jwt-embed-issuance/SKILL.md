...
- Skill: [`../rls-policy-authoring/SKILL.md`](../rls-policy-authoring/SKILL.md) — the DB-side or semantic-layer-side enforcement that the JWT's `tenant_id` drives
- Skill: [`../embed-csp-and-iframe-sandboxing/SKILL.md`](../embed-csp-and-iframe-sandboxing/SKILL.md) — the iframe/CSP boundary that contains the embed
