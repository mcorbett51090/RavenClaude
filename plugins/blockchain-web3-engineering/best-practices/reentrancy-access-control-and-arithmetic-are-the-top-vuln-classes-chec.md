# Reentrancy, access-control, and arithmetic are the top vuln classes — checks-effects-interactions.
...
The §4 failure mode: acting as if "reentrancy, access-control, and arithmetic are the top vuln classes — checks-effects-interactions." weren't true — the most common way an analysis quietly misleads the practitioner who acts on it. The plugin's advisory hook flags a deliverable that reads as if this rule were ignored.
