...
Reference docs that capture lessons earned in real PSM books and research-distilled foundational references. Two waves:
...
The `learning-analytics-analyst`, `partner-success-manager`, `ferpa-comms-translator`, `success-playbook-designer`, `partner-profile-curator`, and `qbr-composer` agents carry compact inline priors summarizing relevant files.
