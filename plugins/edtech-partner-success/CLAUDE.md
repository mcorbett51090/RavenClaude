...
| [`skills/rostering-data-quality/SKILL.md`](skills/rostering-data-quality/SKILL.md) | `learning-analytics-analyst`, `partner-success-manager` | Diagnosing rostering / SIS / LMS sync issues. K-12 (Clever, ClassLink, OneRoster), higher-ed (SIS / LMS), corp L&D (HRIS sync). When to escalate to product vs. when to coach the partner's admin. |
| **v0.4.2** [`skills/advocacy-program-design/SKILL.md`](skills/advocacy-program-design/SKILL.md) | `success-playbook-designer`, `ferpa-comms-translator`, `partner-success-manager`, `ravenclaude-core/documentarian` | The 5-tier advocacy ladder (logo → quote → case study → speaker → peer call); health-score eligibility gate (top-quartile only); pipeline-check + topic-match-to-strength flow; state-law overlay; FERPA overlay for student/parent quotes; pre-publication checklist. |
| **v0.4.2** [`skills/adoption-sequencing-k12/SKILL.md`](skills/adoption-sequencing-k12/SKILL.md) | `learning-analytics-analyst`, `success-playbook-designer`, `partner-success-manager` | Stage 1-4 sequencing rules (newly-implemented / first-year-sustaining / multi-year-mature / pre-renewal); surface-by-surface adoption rhythm; diagnostic-before-intervention discipline. **DO NOT push feature-breadth in stage 1.** |
| **v0.4.2** [`skills/implementation-90-day-arc/SKILL.md`](skills/implementation-90-day-arc/SKILL.md) | `partner-success-manager`, `learning-analytics-analyst` | The 90-day technical-onboarding arc (discovery weeks 1-2 → setup weeks 3-4 → train-the-trainer weeks 5-6 → go-live + Day-30 measurement weeks 7-8 → stabilization weeks 9-12). Calendar-dead-zone go-live check is the highest-leverage pre-flight check. |
| **v0.4.2** [`skills/partner-training-program-design/SKILL.md`](skills/partner-training-program-design/SKILL.md) | `ravenclaude-core/documentarian`, `partner-success-manager`, `success-playbook-designer` | Train-the-trainer is the only model that scales in K-12. K-12 PD modality decision rule (live-in-person / live-virtual / hybrid / async-with-followup); PD-credit alignment; teacher-union overlay in unionized states. |
| [`skills/renewal-play-design/SKILL.md`](skills/renewal-play-design/SKILL.md) | `success-playbook-designer`, `partner-success-manager` | The T-180 → T-0 renewal motion. Sponsor-confirmation arc, value-evidence pack, multi-thread the buying committee, decision-memo support, expand/maintain/contract decision rule, "no surprises" sequence. K-12 / higher-ed / corp L&D segment overlays (K-12 starts at T-180, not T-120). Anti-pattern: renewal pitched at T-7. |
