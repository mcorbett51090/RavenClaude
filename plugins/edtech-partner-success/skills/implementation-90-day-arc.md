...
>
> **When to invoke:** at contract close, alongside [`success-plan-authoring.md`](success-plan-authoring.md). Use throughout the 90-day arc as the playbook for what should be happening when.
>
...
- The partner is post-implementation. Use [`success-plan-authoring.md`](success-plan-authoring.md) for ongoing engagement.
...
- [`success-plan-authoring.md`](success-plan-authoring.md) — the outcome-side counterpart skill
- [`partner-health-scoring.md`](partner-health-scoring.md) — health-score baseline established at Day 30
