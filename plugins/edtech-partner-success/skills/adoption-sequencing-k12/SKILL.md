...
- The adoption signal is broken (rostering issue, telemetry gap). Diagnose the signal first via [`rostering-data-quality.md`](../rostering-data-quality/SKILL.md) before sequencing.
...
- [`rostering-data-quality.md`](../rostering-data-quality/SKILL.md) — signal-trust check
- [`partner-health-scoring.md`](../partner-health-scoring/SKILL.md) — the broader health-score pattern
