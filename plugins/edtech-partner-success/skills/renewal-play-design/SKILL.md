...
|---|---|---|---|
| T-180 | Sponsor confirmation arc starts | Verify the named sponsor is still in role, still the decision-maker, still engaged | [`executive-sponsor-mapping.md`](../executive-sponsor-mapping/SKILL.md) |
| T-120 | Value-evidence pack assembled | 3-5 specific outcomes the partner now has that they didn't pre-purchase, tied to the original success plan | [`success-plan-authoring.md`](../success-plan-authoring/SKILL.md) |
| T-90 | Multi-thread the buying committee | Champion + economic buyer + IT/ops + skeptic all confirmed engaged | [`executive-sponsor-mapping.md`](../executive-sponsor-mapping/SKILL.md) |
...
| T-0 | Renewal in hand | Captured in profile; expansion-readiness check kicks off if applicable | [`expansion-play-design.md`](../expansion-play-design/SKILL.md) |

**If any milestone is missed, the play branches into a recovery sub-play** — see [`recovery-play-design.md`](../recovery-play-design/SKILL.md). Don't keep marching forward as if the milestone happened; missed milestones are the leading indicator.
...
- **Has the sponsor attended the last 2 QBRs?** Attendance is a sponsor-health signal. Two no-shows = potential ghost sponsor (see [`executive-sponsor-mapping.md`](../executive-sponsor-mapping/SKILL.md)).
...
- The advocacy-program ask (if the partner is top-quartile and is willing — see [`advocacy-program-design.md`](../advocacy-program-design/SKILL.md))
...
The multi-thread coverage gap visualization (see [`executive-sponsor-mapping.md`](../executive-sponsor-mapping/SKILL.md)) makes the gaps visible. A blank cell at T-90 = a touchpoint to schedule, not a worry to file.
...
- Shares 1-2 peer-segment reference points (anonymized; via [`advocacy-program-design.md`](../advocacy-program-design/SKILL.md))
...
- **Expand** → trigger [`expansion-play-design.md`](../expansion-play-design/SKILL.md) *after* the renewal closes, not bundled in
- **Maintain** → renew flat (or with standard increase) and continue
- **Contract / exit** → trigger [`recovery-play-design.md`](../recovery-play-design/SKILL.md) immediately; the renewal motion *is* the recovery
...
- The partner is in active recovery (red health). The renewal motion *is* the recovery — use [`recovery-play-design.md`](../recovery-play-design/SKILL.md) and adapt the renewal sub-play out of it, not the other way around.
...
- [`executive-sponsor-mapping.md`](../executive-sponsor-mapping/SKILL.md) — sponsor + multi-thread discipline
- [`expansion-play-design.md`](../expansion-play-design/SKILL.md) — post-renewal expansion motion
- [`recovery-play-design.md`](../recovery-play-design/SKILL.md) — when renewal is at risk
- [`partner-health-scoring.md`](../partner-health-scoring/SKILL.md) — health gate inputs
- [`qbr-composition.md`](../qbr-composition/SKILL.md) — renewal-QBR variant
- [`success-plan-authoring.md`](../success-plan-authoring/SKILL.md) — original goals as the basis for the value-evidence pack
