...
4. **Flag the renewal play** (see [`renewal-play-design.md`](renewal-play-design.md)) — sponsorship gap is a known leading indicator of renewal risk
5. **Trigger recovery play if applicable** (see [`recovery-play-design.md`](recovery-play-design.md)) — if combined with another red flag
...
- [`renewal-play-design.md`](renewal-play-design.md) — T-180 sponsor confirmation arc uses this map
- [`recovery-play-design.md`](recovery-play-design.md) — sponsorship-hypothesis diagnostic uses this map
- [`expansion-play-design.md`](expansion-play-design.md) — Gate 3 (organizational readiness) uses this map
- [`partner-health-scoring.md`](partner-health-scoring.md) — champion-strength signal feeds from this map
- [`qbr-composition.md`](qbr-composition.md) — QBR attendance is a sponsor-health signal
