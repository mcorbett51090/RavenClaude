...
2. **Health-score filter** — only top-quartile-health partners are eligible. Bottom-quartile partners are explicitly excluded (their story is unstable + the ask burns goodwill they don't have). See [`partner-health-scoring.md`](partner-health-scoring.md).
...
- [`partner-health-scoring.md`](partner-health-scoring.md) — health-score eligibility gate
