...
2. **Identify the training motion type:**
   - **Implementation training** — at go-live; covered by [`implementation-90-day-arc.md`](implementation-90-day-arc.md) week 5-6 + [`../templates/train-the-trainer-curriculum.md`](../templates/train-the-trainer-curriculum.md)
...
- [`implementation-90-day-arc.md`](implementation-90-day-arc.md) — where this skill plugs into the implementation arc (weeks 5-6)
