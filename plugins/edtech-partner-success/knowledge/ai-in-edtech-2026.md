...
| **Anthropic** | Claude for Education (higher-ed) + **Claude for Teachers (K-12, launched 2026-07-14)** | Claude for Education (April 2025, higher-ed — Learning Mode / Socratic tutoring; powers Khanmigo). **Claude for Teachers (2026-07-14)** closes the prior K-12 gap: Anthropic states verified US K-12 educators who **enroll by 2027-06-30** get a **1-year free Claude Pro** tier; data **not used for training**; K-12 DPA **"FERPA-aligned"** (Anthropic's term — see caveats under the table). **Confidence: High** it launched; product specifics are vendor self-reports (`[verify-at-use]`, retrieved 2026-07-21). [Anthropic](https://www.anthropic.com/news/claude-for-teachers) · [Terms](https://support.claude.com/en/articles/15926041-claude-for-teachers-your-data-and-our-terms) · [Claude for Education](https://claude.com/solutions/education) |
...
**PSM tell:** when a partner asks "what about ChatGPT?", they often mean the free educator tier — they're not necessarily evaluating a paid vendor. **As of 2026-07-14 the same tell applies to Anthropic** — "what about Claude?" now often means the free Claude for Teachers tier, not a paid eval.

**Claude for Teachers — the PSM detail (launched 2026-07-14; product specifics are Anthropic self-reports, `[verify-at-use]`).** Anthropic states the free year of Claude Pro (incl. Claude Code + Cowork) covers verified US K-12 staff broadly — classroom teachers (K-12, any subject), instructional coaches, specialists, interventionists, librarians, counselors, and other certificated staff (verify with a professional email); enrolling by **2027-06-30** secures the free year. Lessons are grounded via **Learning Commons** (Anthropic: a live ~150k-standard database across all 50 states, plus sub-competencies and typical learning order — grounding, not model memory). Three caveats that protect the PSM in a client conversation:

- **"FERPA-aligned" ≠ "FERPA-compliant."** Anthropic describes the **K-12** DPA as *FERPA-aligned* (terms written with FERPA in mind); EdWeek (2026-07) reports critics flag that "aligned" is not "compliant." Carry the vendor's exact word to a district CIO — don't upgrade it. (Higher-ed FERPA questions fall under Claude for Education's own terms, not this K-12 DPA.)
- **AFT = partnership, not certification.** Anthropic says it is partnering with the American Federation of Teachers to align terms/privacy with a union-developed "Gold Standard" — a stated collaboration, **not** an AFT-issued certification of the product.
- **Post-free-year cost is not specified** in the launch materials surfaced here — a district's cost after the 12-month window (and per-seat Claude for Education higher-ed pricing) is the first renewal-competitive follow-up a client will ask; `[verify-at-use]` before quoting.

Sources retrieved 2026-07-21 via WebSearch (Anthropic + news domains 403 automated fetch — the repo's primary-403→cross-reference pattern): [Anthropic announcement](https://www.anthropic.com/news/claude-for-teachers), [terms/data Help Center](https://support.claude.com/en/articles/15926041-claude-for-teachers-your-data-and-our-terms); corroborated by Forbes / EdWeek / 9to5Mac (2026-07-14) and TechTimes (2026-07-15). See also [`coppa-2025-amendment-edtech-implications.md`](coppa-2025-amendment-edtech-implications.md) and [`parent-comms-jurisdictional-bear-traps.md`](parent-comms-jurisdictional-bear-traps.md) for the FERPA/COPPA overlay.
