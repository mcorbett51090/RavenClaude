...
See [`CLAUDE.md`](CLAUDE.md) for the full team constitution (roster, routing rules, the §3/§house opinions the hook enforces, and the ALM/governance anti-patterns).
