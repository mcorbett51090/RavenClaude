...
The same silent-zero shape applies to **question numbers** in a scorer DAX, not just category names. From the BMA-CSP-Risk-Scoring session (`mcorbettbma/ContosoReporting`, 2026-06-04):
