...
|---|---|
| **Fable 5 / Mythos 5** (Mythos-class; `claude-fable-5`) | **GA 2026-06-09** — Anthropic Pro/Max/Team/Enterprise, **AWS Bedrock**, **GitHub Copilot**. Microsoft Foundry: **announced** (Azure blog + `ai.azure.com` catalog page) but the authoritative Foundry **Learn** model table **still does NOT list `claude-fable-5`** (lists Opus/Sonnet/Haiku previews + gated `claude-mythos-preview`) — re-verified 2026-06-11 via Microsoft-Learn. Mythos 5 = safeguards-lifted sibling, not recommended here. `[verify-at-use]` |
