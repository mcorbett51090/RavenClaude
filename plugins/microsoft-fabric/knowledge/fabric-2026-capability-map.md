...
| 2.0 | Spark 4.1 / Delta 4.2 (Python 3.13) | **public preview** — not the production default yet. **Updated Spark 4.0→4.1 / Delta 4.0→4.2 / Python 3.12→3.13**; the Python bump is a **breaking change** — re-publish every Environment that has libraries or Spark jobs fail "No module found" (Delta 4.1→4.2 re-verified 2026-08-11, [Runtime 2.0](https://learn.microsoft.com/fabric/data-engineering/runtime-2-0)) |
