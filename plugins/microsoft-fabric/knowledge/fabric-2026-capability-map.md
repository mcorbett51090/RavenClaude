...
| **1.3** | Spark 3.5.5 / Delta 3.2 | **current GA** (LTS) — production default; **end-of-support 2026-09-30, then LTS Oct 2026 → March 2027** `[verify-at-use]` ([runtime](https://learn.microsoft.com/fabric/data-engineering/runtime), [lifecycle](https://learn.microsoft.com/fabric/data-engineering/lifecycle), Microsoft-Learn 2026-06-18) — EOS is ~5 weeks out (as of 2026-08-24) and **Runtime 2.0 is now GA**, so plan the migration now (2.0 is GA but not yet the workspace default) |
