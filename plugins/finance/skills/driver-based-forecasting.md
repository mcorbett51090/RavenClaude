...
See [`./variance-commentary.md`](./variance-commentary.md) for the downstream commentary discipline.
...
- Skill: [`./model-review.md`](./model-review.md) — 7-pass review every model goes through before ship
- Skill: [`./variance-commentary.md`](./variance-commentary.md) — the downstream commentary discipline
- Skill: [`./thirteen-week-cash-forecast.md`](./thirteen-week-cash-forecast.md) — direct cash forecast (different mechanic)
