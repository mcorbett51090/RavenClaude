...
- Skill: [`./month-end-close.md`](./month-end-close.md) — many ToD/ToE walkthroughs occur in close
...
- Cross-plugin: [`../../regulatory-compliance/skills/control-testing.md`](../../regulatory-compliance/skills/control-testing.md) — regulator-facing control testing (related but distinct discipline)
