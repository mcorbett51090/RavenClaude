...
- [ ] BS and CF for the projection internally consistent (the underlying model passes the [`../model-review/SKILL.md`](../model-review/SKILL.md) 7-pass)
...
- Skill: [`../model-review/SKILL.md`](../model-review/SKILL.md) — 7-pass model integrity check (DCF inherits this)
- Skill: [`../driver-based-forecasting/SKILL.md`](../driver-based-forecasting/SKILL.md) — the projection the DCF runs on
- Skill: [`../board-pack-composition/SKILL.md`](../board-pack-composition/SKILL.md) — for presenting valuation work to a board
