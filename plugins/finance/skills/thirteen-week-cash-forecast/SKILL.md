...
See [`../board-pack-composition/SKILL.md`](../board-pack-composition/SKILL.md) for lender-pack specifics.
...
- Skill: [`../month-end-close/SKILL.md`](../month-end-close/SKILL.md) — the close cadence the 13W shouldn't conflict with
- Skill: [`../board-pack-composition/SKILL.md`](../board-pack-composition/SKILL.md) — lender-pack specifics (covenant-compliance, borrowing-base)
