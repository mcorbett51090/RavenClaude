...
- Skill: [`../variance-commentary/SKILL.md`](../variance-commentary/SKILL.md) — KPI commentary uses these definitions
- Skill: [`../board-pack-composition/SKILL.md`](../board-pack-composition/SKILL.md) — KPIs on the front 5-7 slides
- Skill: [`../driver-based-forecasting/SKILL.md`](../driver-based-forecasting/SKILL.md) — KPI drivers feed the forecast
