...
Use the [`../variance-commentary/SKILL.md`](../variance-commentary/SKILL.md) skill for the prose. Place commentary **inline with the variance**, not in a separate section. Reading a number and then having to flip 8 pages for the explanation is a UX failure.
...
- Skill: [`../variance-commentary/SKILL.md`](../variance-commentary/SKILL.md)
